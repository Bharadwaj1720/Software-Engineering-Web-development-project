...
function doctor(date,time)
{
    ...
    if(time[5]=='a'&&time[0]<'8')return doctor[l];
    if(time[5]=='a'&&time[0]>'8')return doctor[l+1];
    if(time[5]=='p'&&time[0]<'4')return doctor[l+1];
    if(time[5]=='p'&&time[0]>'4')return doctor[l+2];

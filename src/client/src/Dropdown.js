        ...
        <Dropdown>
            ...
            <Dropdown.Menu>
                ...
                <Form onSubmit={onSubmit}>
                    <Dropdown.Item href="#/action-3"><Button type="submit" style={{ backgroundColor: "inherit", border: "0" }}><Link to="">Logout</Link></Button></Dropdown.Item>
                    <Dropdown.Item href="#/action-4"><Button type="submit" style={{ backgroundColor: "inherit", border: "0" }}><Link to="">Logout all</Link></Button></Dropdown.Item>
                </Form>
            </Dropdown.Menu>
        </Dropdown>
    );

            ...
            <form className="p-4 appointmentForm" onSubmit={onSubmit}>
              ...
              <div className="form-group row">
                ...
                <div className="form-group top col-md-7 mx-auto">
                  ...
                  <input className="form-control border border-dark rounded-0" type="text"  id="appointment_id" value={form.appointment_id}
           onChange={(e) => updateForm({ appointment_id: e.target.value })} ></input>
                </div>

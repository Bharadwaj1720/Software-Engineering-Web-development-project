...
export default function Login() {
    ...
    async function onSubmit(e) {
        setGlobalState("Gusername", form.username);
        e.preventDefault();
        ...
        setGlobalState("Gdevice_id", Math.random());
        setGlobalState("Gstatus", answer.status);
        setGlobalState("Gtoken", answer.auth_token);
                    ...
                    <div className="container text-center">
                        <div className="row">
                            ...
                            <div className="col-md-4" style={{
                                ...
                                <Form>
                                    <div>
                                        <input type="text" placeholder="Username" style={{ marginTop: 10 }} value={form.username} onChange={(e) => { updateForm({ username: e.target.value, device_id: 1 }) }} />
                                    </div>
                                    <div>
                                        <input type="password" placeholder="Password" style={{ marginTop: 10 }} value={form.password_plaintext} onChange={(e) => updateForm({ password_plaintext: e.target.value })} />
                                    </div>
                                    <Button variant="primary" value="Create person" className="login_but" style={{
                                        marginTop: 10,
